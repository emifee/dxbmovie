      ...
      <div className="relative w-full max-w-md animate-slide-up rounded-t-3xl bg-surface p-6 sm:rounded-3xl sm:shadow-2xl">
        ...
        {step === "review" && (
          <>
            <div className="mb-4 flex items-center gap-2">
              <h2 className="text-lg font-bold text-white">How are you finding WaZhop DXB Cinema?</h2>
            </div>
        ...
        {step === "done" && (
          <div className="flex flex-col items-center gap-3 py-6 text-center">
            ...
            <p className="text-sm text-text-secondary">Your feedback shapes WaZhop DXB Cinema. We really appreciate it.</p>
          </div>
        )}
      </div>
    </div>
