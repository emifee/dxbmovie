...
export const commerceTools = {
  search_catalog: {
    description: "Search the internal WaZhop DXB Cinema product catalog for merchandise related to a movie, character, or general query. Use this to find products.",
    parameters: {
      type: "object",
      properties: {
