...
export const metadata: Metadata = {
  title: "Data Deletion Instructions | WaZhop DXB Cinema",
  description: "Instructions for requesting the deletion of your data from WaZhop DXB Cinema.",
};
    ...
    <main className="mx-auto max-w-2xl px-6 py-12 text-sm leading-relaxed text-text-secondary">
      ...
      <section className="space-y-6">
        <div>
          ...
          <p>
            At WaZhop DXB Cinema, we respect your privacy and your right to control your personal data. 
            This page provides instructions on how to request the deletion of any personal data we 
            may hold about you, including data from your WaZhop DXB Cinema account and any data received 
        ...
        <div>
          ...
          <ul className="mt-2 list-inside list-disc space-y-1">
            <li><strong>WaZhop DXB Cinema Account Data:</strong> Profile information (name, email, profile picture), movie preferences, watchlists, reactions, and AI companion conversation history.</li>
        ...
        <div>
          ...
          <ul className="mt-2 list-inside list-disc space-y-1">
            ...
            <li>The <strong>email address</strong> associated with your WaZhop DXB Cinema account (if you have one).</li>
