      ...
      <div className={cn("relative mx-auto w-full max-w-app px-5 pb-24 pt-10 lg:max-w-3xl lg:px-10 lg:pb-12", chatOpen && "invisible lg:visible")}>
        ...
        <div className="flex flex-col items-center text-center">
          {signedIn ? (
            ...
            <div className="relative mx-auto mt-4 flex w-full max-w-md flex-col items-center justify-center overflow-hidden rounded-[2rem] border border-white/5 bg-surface/40 p-10 text-center shadow-2xl backdrop-blur-xl">
              {/* Decorative background glows */}
              <div className="pointer-events-none absolute -left-20 -top-20 h-56 w-56 rounded-full bg-primary/20 blur-[80px]" />
              <div className="pointer-events-none absolute -bottom-20 -right-20 h-56 w-56 rounded-full bg-blue-500/20 blur-[80px]" />
              
              <div className="relative z-10 flex flex-col items-center">
                <div className="group relative mb-8">
                  <div className="absolute inset-0 rounded-full bg-gradient-primary opacity-40 blur-xl transition-opacity duration-500 group-hover:opacity-70" />
                  <div className="relative grid h-24 w-24 place-items-center rounded-full border border-white/10 bg-surface/80 shadow-[0_0_40px_-10px_rgba(255,255,255,0.1)] transition-transform duration-500 group-hover:-translate-y-1 group-hover:scale-105 backdrop-blur-sm">
                    <User size={36} className="text-white drop-shadow-[0_0_12px_rgba(255,255,255,0.4)]" />
                  </div>
                </div>
                
                <h1 className="text-3xl font-extrabold tracking-tight text-transparent bg-clip-text bg-gradient-to-b from-white to-white/70">
                  Welcome to DXBmovies
                </h1>
                <p className="mt-4 max-w-sm text-[15px] leading-relaxed text-text-secondary">
                  Unlock your personal AI movie companion, curate your watchlist, and sync your cinematic universe across all devices.
                </p>
                
                <button 
                  onClick={openAuthGate} 
                  className="group relative mt-10 flex w-full items-center justify-center gap-3 rounded-2xl bg-white px-8 py-4 font-semibold text-black transition-all hover:scale-[1.02] hover:bg-white/95 active:scale-[0.98] shadow-[0_0_40px_-10px_rgba(255,255,255,0.3)]"
                >
                  <svg className="h-5 w-5 transition-transform duration-300 group-hover:rotate-12" viewBox="0 0 24 24">
